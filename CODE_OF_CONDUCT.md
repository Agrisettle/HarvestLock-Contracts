...
requests, discussions, commit messages — and when an individual is
officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainer at **samuelojetunde898@gmail.com**
(same contact as [`SECURITY.md`](./SECURITY.md)). All complaints will be
reviewed and investigated promptly and fairly, and the reporter's
...
Identical to [`HarvestLock`](https://github.com/Agrisettle/HarvestLock)'s
copy of this file — same org, same standard, matching this repo's own
`README.md`'s note that `CONTRIBUTING.md` lives in the main repo rather
